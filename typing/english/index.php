...
<body>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8 p-1">
                        <select class="form-select" id="para">
                            ...
                            <option value="2" style="">Brothers</option>

                            <option value="3" style="">The Awakening</option>
                            <option value="4" style="">Christmas Carol</option>
                            <option value="5" style="">Fairy Tales</option>
    ...
    <div class="container tester" style="display:none">
        <div class="card mt-1 col-9 m-auto shadow">
            ...
            <div class="card-body">
                <div class="border p-2 overflow-auto bg-light" id="textbook" style="height:250px;font-size:20px;"></div>
                <div class="bg-danger">
                    <button class="btn btn-danger">GWPM <span class="gwpm">0.00</span></button>
                    <button class="btn btn-danger">NWPM <span class="nwpm">0.00</span></button>
                    <button class="btn btn-danger">ACCU <span class="acc">0</span>%</button>
                ...
                <div class="card border" style="height:250px">
                    <textarea style="height:100%;resize: none;border:none;outline:none;" id="textcopy" class="p-2"></textarea>
